                    ...
                    <div className="grid gap-6 py-4">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                            ...
                                            <div className="space-y-2">
                                                {isLoadingRepos ? (
                                                    ...
                                                    filteredRepos.map((repo) => (
                                                        <div
                                                            key={repo.id}
                                                            className={`flex flex-col sm:flex-row sm:items-center sm:justify-between rounded-md p-2 hover:bg-accent ${selectedRepo === repo.id ? "bg-accent" : ""
                                                                }`}
                                                        >
                                                            <div className="flex items-start sm:items-center space-x-2 mb-2 sm:mb-0">
                                                                ...
                                                                <div className="flex flex-col">
                                                                    <span className="font-medium truncate max-w-[260px] sm:max-w-[180px] md:max-w-[200px]">
                                                                        {repo.fullName}
                                                                    </span>
                                                                    {repo.description && (
                                                                        <span className="text-xs text-muted-foreground truncate max-w-[260px] sm:max-w-[180px] md:max-w-[200px]">
                                                                            {repo.description}
                                                                        </span>
                                                                    )}
                                                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    {/* //TODO: Add a select for the branch */}
                                ...
                                <div className="space-y-2">
                                    ...
                                    >
                                        <SelectTrigger id="teamId" className="bg-input w-full">
